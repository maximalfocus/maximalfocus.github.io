...
```mermaid
graph TD
    A["<b>Previous State</b><br>CAC + COGS > LTV"] --> B[Business is not viable];
    C["<b>With AI</b><br>AI Sales Reps lower CAC<br>AI Operations lower COGS"] --> D["CAC + COGS < LTV"];
